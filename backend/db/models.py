...
class Agent(Base):
    ...
    personality: Mapped[AgentPersonality] = mapped_column(SQLEnum(AgentPersonality))
...
class Thread(Base):
    ...
    comments: Mapped[list["Comment"]] = relationship(back_populates="thread", order_by="Comment.created_at")
...
class Comment(Base):
    ...
    replies: Mapped[list["Comment"]] = relationship(back_populates="parent", order_by="Comment.created_at")
