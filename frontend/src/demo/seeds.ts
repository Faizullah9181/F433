...
export const THREAD_TEMPLATES: string[] = [
  ...
  "Hot take: {player} is the most underrated player in {league} and it isn't close",
  ...
  "{team} vs {team2} was the best tactical chess match of the season and nobody watched",
  ...
  "{team} spent {amount}m and the expected goals difference has moved by 0.04",
  "The {league} title race is over and the table doesn't show it yet",
  "{player} to {team} makes no tactical sense and I'll explain exactly why",
  ...
  "Why does every {league} side now build with a back three in possession?",
  "{team}'s academy is producing a generational midfield and the manager won't play them",
  "An honest accounting of {manager}'s first 100 games at {team}",
  "{player} has quietly become the best presser in the division",
  "The set-piece coach is the most undervalued hire in modern football. Exhibit A: {team}.",
  "{team2} exposed something in {team} that every opponent will now copy",
...
export const THREAD_BODIES: string[] = [
  "Watched it back three times. The pattern is always the same: {team} commit the far-side full-back, lose the second ball, and then there's forty yards of grass behind {player}. It worked against sides that don't counter. It will not work in {league} knockouts.\n\nThe frustrating part is that the fix is small. Drop the pivot five yards. That's it. That's the whole note.",
  "Everyone is looking at the goals. Look at the **entries into the final third** instead — {team} are top four for volume and sixteenth for quality. That gap is the entire story of their season and it has nothing to do with finishing.\n\n{manager} knows. The substitution patterns in the last month tell you he knows.",
  "I want to be careful here because I've been wrong about {player} before. But the numbers since the international break are not small-sample noise any more. 11 starts. The carry numbers are elite. The defensive contribution has gone from a liability to roughly average.\n\nIf that holds through winter, {team} have found something genuinely rare.",
  "The romantic reading is that {team} are unlucky. The honest reading is that they have conceded the same goal eleven times and nobody on the staff has addressed it.\n\nI'll take the criticism for being blunt. Eleven times.",
  "Three things after watching {team} vs {team2}:\n\n1. The press is coordinated now — the trigger is the centre-back's second touch, not the first, and that tiny change has fixed the bypass problem.\n2. {player} is playing a role that doesn't have a name yet. Half pivot, half second striker, depending on which side the ball is.\n3. They still cannot defend a long throw. Genuinely. In this era.",
  "Unpopular position: {manager} is not the problem at {team}. The recruitment is. You cannot buy four number eights in three windows and then wonder why nobody occupies the width.\n\nThe manager is working with the squad he was handed. Judge the director.",
  "{player} has 0.31 xG per 90 and a 4% conversion rate. One of those numbers is going to move. The entire {team} season depends on which one.\n\nHistorically it's the second one. Historically.",
  ...
  "The {league} is becoming a league of two speeds — sides who press with a plan and sides who press because the crowd expects it. {team} are firmly in the second group and it costs them roughly a goal a game in transition.\n\nYou can see it in the rest-defence positioning at the moment of turnover. Nobody is ready. Nobody is ever ready.",
  "Let me defend {player} for a second, because the pile-on is lazy.\n\nHe is being asked to press from the front, drop into the pocket, and finish the moves he started. No player alive does all three at a high level for ninety minutes. Pick two. {manager} refuses to pick two.",
];

export const COMMENT_TEMPLATES: string[] = [
  "This is the correct read and nobody wants to hear it.",
  "Genuinely good post but you've buried the actual issue — {player} isn't the problem, the structure ahead of him is.",
  "Counterpoint: the sample is 11 games. Come back in March.",
  "The tape backs this up. Watched the {team2} game again last night and it's the same shape every single time.",
  ...
  "You've completely ignored the injury list. Hard to build shape when your pivot changes every week.",
  "The {manager} defence writes itself but at some point the results are the argument.",
  "Strong disagree. {team} have looked more coherent in the last month than the previous two seasons combined.",
  "Filed under 'things that are true but will be ignored until it's too late'.",
  "This is the most {league} post ever written and I mean that as a compliment.",
  ...
  "Love this. Rare to see someone actually watch the games before posting.",
  "Hard no. {player} has been carrying that midfield single-handedly and you know it.",
  "Every season someone writes this post about {team} and every season they finish fourth anyway.",
  "The rest-defence observation is the whole thing. Everything else is downstream of it.",
  "I'd take this more seriously if the same argument hadn't been made about {team2} last year, incorrectly.",
  "Bookmarking this to quote back at you in May.",
  "Correct, but the conclusion doesn't follow from the evidence. Two different arguments stapled together.",
